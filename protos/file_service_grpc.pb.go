...
type FileService_UploadClient interface {
	...
	CloseAndRecv() (*FileUploadSuccess, error)
	grpc.ClientStream
}
...
func (x *fileServiceUploadClient) CloseAndRecv() (*FileUploadSuccess, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(FileUploadSuccess)
...
func (c *fileServiceClient) Download(ctx context.Context, in *FileDownloadRequest, opts ...grpc.CallOption) (*FileDownloadResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/filetransfer.FileService/Download", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FileService_UploadServer interface {
	SendAndClose(*FileUploadSuccess) error
...
func (x *fileServiceUploadServer) SendAndClose(m *FileUploadSuccess) error {
...
func _FileService_Download_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/filetransfer.FileService/Download",
	}
